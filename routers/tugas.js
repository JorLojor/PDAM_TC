...
router.put('/pengumpulan/:id',auth.user,upload.single('answer-file'),Controller.pengumpulanTugas);
router.put('/updatePengumpulan/:id',auth.user,upload.single('answer-file'),Controller.updatePengumpulanTugas);
